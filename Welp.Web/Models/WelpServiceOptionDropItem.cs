...
{
    public class WelpServiceOptionDropItem
    {
        [Key]
        ...
        [Display(AutoGenerateField = false)]
        public int WelpServiceOptionId { get; set; }

        [ForeignKey(nameof(WelpServiceOptionId))]
        public WelpServiceOption Option { get; set; }
